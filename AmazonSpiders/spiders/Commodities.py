...
class CommoditiesSpider(scrapy.Spider):
    name = 'Commodities'

    def __init__(self, search_key=None, country=None, *args, **kwargs):
        super(CommoditiesSpider, self).__init__(*args, **kwargs)
        remove_log()
        if country == 'jp':
            self.start_urls = [
            ...
            self.start_urls = [
                'https://www.amazon.cn/s?k={}&__mk_zh_CN=亚马逊网站&ref=nb_sb_noss_2'.format(search_key)]
